...
public class ClickGUI extends JFrame implements NativeMouseListener, NativeKeyListener {
    ...
    public ClickGUI() {
    	...
    	startButton.addActionListener(new ActionListener() {
	  		public void actionPerformed(ActionEvent e) {
	  			try {
	  				nome = JOptionPane.showInputDialog(null, "Informe o nome do programa");
        ...
        stopButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
    			try { 
                    ...
                    Process p = Runtime.getRuntime().exec("compiler.bat " + nome);
    ...
    public void nativeMouseClicked(NativeMouseEvent e) {
    	...
    	if (file.exists()) {   	  		
    		...
    		try {
		        ...
		        writer.close();
		        System.out.println("Linha adicionada ao arquivo " + nome + ".java");
    		} catch (IOException ex) {
        ...
        try {
            FileWriter writer = new FileWriter(nome + ".java", true);
    ...
    public void nativeKeyPressed(NativeKeyEvent e) {
        ...
        try {
            ...
            writer.close();
            System.out.println("Tecla pressionada salva em "+ nome + ".java" + NativeKeyEvent.getKeyText(lastPressedKey));
        } catch (IOException ex) {
